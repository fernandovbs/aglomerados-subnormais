...
aglomerados_subnormais description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and aglomerados_subnormais installed into it (latter is installed in
...
install it (`pip install aglomerados_subnormais.tar.gz`), ensure that configuration file exists and
`AGLOMERADOS_SUBNORMAIS_SETTINGS` environment variable points to it, ensure that user has access to the
